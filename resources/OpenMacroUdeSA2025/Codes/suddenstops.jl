...
function SOEss(; β = 0.97, γ = 2, r = 0.02, ϖN = 0.55, η = 1/0.83-1, κ = 0.35, α = 0.67, wbar = 0.8, ρz = 0.945, σz = 0.02, Na = 40, Nz = 21, amin = -0.5, amax = 10)
	...
	return SOEss(pars, agrid, zgrid, Pz, v, gc, ga, pN, w, Ap, Y)
end

function optim_value(av, yv, Apv, pz, pCv, itp_v, sw::SOEss)
